...
# system platform
system_platform = $(DEFAULT_PLATFORM)
ifeq ($(shell uname -a),)
	EXE_EXT = .exe
	system_platform = win
else ifneq ($(findstring Darwin,$(shell uname -a)),)
...
# android arm
	...
	CFLAGS += -DDEFAULT_CFG_NAME="\"/mnt/sdcard/f8emu.cfg\""
...
# Nintendo Game Cube / Wii / WiiU
   ...
   ifneq (,$(findstring wiiu,$(platform)))
      CFLAGS += -DDEFAULT_CFG_NAME="\"sd:/retroarch/cores/system/f8emu.cfg\""
